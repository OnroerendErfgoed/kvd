...
/**
 * KVDdom_Fields_CollectionFieldTest 
 * 
 * @package     KVD.dom
 * @subpackage  fields
 * @category    test
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU General Public License
 */
class KVDdom_Fields_CollectionFieldTest extends PHPUnit_Framework_TestCase
{
    public function setUp( )
    {
        $this->dom = $this->getMock( 'KVDdom_SimpleTestDomainObject', array(), array(1, 'Een eerste object') );
        $this->field = new KVDdom_Fields_CollectionField( $this->dom, 'eigenaars' );
