 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class VIOE_Sniffs_Commenting_ClassCommentSniff extends VIOE_Sniffs_Commenting_FileCommentSniff
{
    ...
    protected $tags = array(
                       ...
                       'since'      => array(
                                        'required'       => true,
                                        'allow_multiple' => false,
                                        'order_text'     => 'follows @version (if used) or @subpackae (if used) or @package',
                                       ),
                       'copyright'  => array(
                                        'required'       => true,
                                        'allow_multiple' => true,
